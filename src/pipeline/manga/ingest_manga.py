...
def run_ingestion():
    ...
    if os.path.exists(OUTPUT_FILE):
        ...
        try:
            ...
            print(f"✅ Found {len(all_mangas)} existing mangas.")
        except Exception as e:
    ...
    print(f"🚀 Starting Manga Ingestion from AniList (Incremental)...")
    ...
    while has_next_page and page <= max_pages:
        ...
        if data and 'data' in data and 'Page' in data['data']:
            ...
            print(f"     -> Added {added_this_page} new mangas this page.")
    ...
    if new_items_count > 0:
        ...
        print(f"✅ Collection finished! Added {new_items_count} new mangas. Total: {len(all_mangas)}")
    else:
        print("ℹ️ No new mangas found. Database is up to date.")
