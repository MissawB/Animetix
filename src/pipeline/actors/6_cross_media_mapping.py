...
def create_mapping_char_actor():
    print(f"   - Mapping character_vibe to actor_vibe...")
    
    try:
        source_coll = chroma_manager.get_collection("character_vibe")
        target_coll = chroma_manager.get_collection("actor_vibe")
