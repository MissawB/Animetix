...
def run_cross_media_linking():
    ...
    manga_by_title = {m['title'].lower(): str(m['id']) for m in mangas if m.get('title')}
    ...
    logger.info(f"✅ Linking Complete. {links_found} relations established between Anime and Manga.")
