...
class SearchPlanner:
    ...
    def plan(self, query: str, memories: str = "", thinking_budget: int = 0, thinking_mode: bool = False) -> SearchPlan:
        ...
        try:
            ...
            logger.warning(f"Structured plan generation failed ({err}), falling back to manual generation...")
            ...
            try:
                ...
                if "graph_traversal_steps" in data and isinstance(data["graph_traversal_steps"], list):
                    cleaned_steps = []
