...
class FormalLogicSolver:
    ...
    def find_intruder(self, items: List[str], properties: Dict[str, Dict[str, bool]]) -> Tuple[Optional[str], str, Dict[str, Any]]:
        """
        ...
        return None, "Z3 UNSAT: No clear logical intruder found.", {"method": "formal", "engine": "Z3 Theorem Prover"}
