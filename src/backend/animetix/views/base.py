...
def start_daily_challenge(request):
    ...
    modes_daily = [
        {"id": "classic", "brush1": "CLASSIC", "brush2": "MODE", "description": "Trouvez le titre mystère du jour via la similarité.", "icon": "/static/animetix/img/ui/frieren.png", "gradient": "from-blue-600 via-indigo-500 to-blue-400", "completed": completed}, 
        {"id": "emoji", "brush1": "EMOJI", "brush2": "DECODE", "description": "Déchiffrez l'œuvre derrière les emojis du jour.", "icon": "/static/animetix/img/ui/Shaman_king.png", "gradient": "from-orange-600 via-red-500 to-amber-400", "completed": completed}, 
        {"id": "animinator", "brush1": "ANIMINATOR", "brush2": "ORACLE", "description": "Posez vos questions à l'Oracle pour débusquer le secret.", "icon": "/static/animetix/img/ui/Sinbad.png", "gradient": "from-purple-700 via-violet-600 to-purple-400", "completed": completed}, 
        {"id": "akinetix", "brush1": "AKINETIX", "brush2": "DEVIN", "description": "L'IA tente de deviner à quelle œuvre du jour vous pensez.", "icon": "/static/animetix/img/ui/Saiki.png", "gradient": "from-pink-600 via-rose-500 to-pink-400", "completed": completed}, 
        {"id": "paradox", "brush1": "PARADOX", "brush2": "QUEST", "description": "Débusquez l'intrus parmi les propositions du jour.", "icon": "/static/animetix/img/ui/Steins_gate.png", "gradient": "from-red-700 via-rose-600 to-red-400", "completed": completed}, 
        {"id": "vision_quest", "brush1": "VISION", "brush2": "QUEST", "description": "Décrivez l'image mystère du jour.", "icon": "/static/animetix/img/ui/SAO.png", "gradient": "from-cyan-600 via-blue-500 to-sky-400", "completed": completed}, 
        {"id": "blindtest", "brush1": "BLIND", "brush2": "TEST", "description": "Devinez l'animé du jour à partir de son opening/ending.", "icon": "/static/animetix/img/ui/Kaori.png", "gradient": "from-green-600 via-teal-500 to-emerald-400", "completed": completed}, 
        {"id": "covertest", "brush1": "COVER", "brush2": "TEST", "description": "Devinez le manga du jour à partir de sa couverture.", "icon": "/static/animetix/img/ui/Bakuman.png", "gradient": "from-amber-600 via-yellow-500 to-orange-400", "completed": completed}
    ]
...
def custom_config_view(request):
    ...
    return render(request, 'animetix/custom_config.html', {
