...
class ArchetypistPresenter:
    ...
    def get_theme_color(title):
        ...
        title = title.lower()
        mapping = {
            'naruto': '#FF9800', 'one piece': '#FBC02D', 'bleach': '#FF5722',
            'hunter x hunter': '#4CAF50', 'dragon ball': '#0277BD',
            'attack on titan': '#795548', 'death note': '#212121',
            'demon slayer': '#E91E63', 'jujutsu kaisen': '#673AB7',
            'frieren': '#80CBC4', 'mushoku': '#AFB42B',
        }
