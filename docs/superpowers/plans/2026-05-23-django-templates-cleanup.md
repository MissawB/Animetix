...
**Files:**
- Modify: [__init__.py](file:///C:/Users/bahma/PycharmProjects/Projet%20solo/Double_scenario_Project/backend/api/animetix/urls/__init__.py)

- [ ] **Étape 1 : Simplifier le fichier de routage central des URLs**
  Modifier `backend/api/animetix/urls/__init__.py` pour retirer toutes les inclusions de fichiers de routage d'anciennes pages HTML, rediriger la racine `/` vers `spa_view` et éliminer les configurations de session inutiles :
  ```python
...
- [ ] **Étape 2 : Commiter les changements de routage de base**
  Exécuter :
  ```powershell
  git add backend/api/animetix/urls/__init__.py
...
**Files:**
- Modify: [donation.py](file:///C:/Users/bahma/PycharmProjects/Projet%20solo/Double_scenario_Project/backend/api/animetix/urls/donation.py)
- Delete: [audio.py](file:///C:/Users/bahma/PycharmProjects/Projet%20solo/Double_scenario_Project/backend/api/animetix/urls/audio.py)
- Delete: [emoji.py](file:///C:/Users/bahma/PycharmProjects/Projet%20solo/Double_scenario_Project/backend/api/animetix/urls/emoji.py)
- Delete: [games.py](file:///C:/Users/bahma/PycharmProjects/Projet%20solo/Double_scenario_Project/backend/api/animetix/urls/games.py)
- Delete: [social.py](file:///C:/Users/bahma/PycharmProjects/Projet%20solo/Double_scenario_Project/backend/api/animetix/urls/social.py)

- [ ] **Étape 1 : Retirer la page de transparence HTML de donation.py**
  Modifier `backend/api/animetix/urls/donation.py` pour retirer l'ancienne page HTML de transparence et ne conserver que le webhook :
  ```python
...
- [ ] **Étape 2 : Supprimer les fichiers d'URLs legacy devenus obsolètes**
  ...
  * `backend/api/animetix/urls/audio.py`
  * `backend/api/animetix/urls/emoji.py`
  * `backend/api/animetix/urls/games.py`
  * `backend/api/animetix/urls/social.py`

- [ ] **Étape 3 : Commiter le nettoyage des fichiers d'URLs**
  Exécuter :
  ```powershell
  git rm backend/api/animetix/urls/audio.py backend/api/animetix/urls/emoji.py backend/api/animetix/urls/games.py backend/api/animetix/urls/social.py
  git add backend/api/animetix/urls/donation.py
...
**Files:**
- Modify: [base.py](file:///C:/Users/bahma/PycharmProjects/Projet%20solo/Double_scenario_Project/backend/api/animetix/views/base.py)

- [ ] **Étape 1 : Nettoyer `backend/api/animetix/views/base.py`**
...
- [ ] **Étape 2 : Commiter le nettoyage des vues**
  Exécuter :
  ```powershell
  git add backend/api/animetix/views/base.py
...
**Files:**
- Delete: [templates/animetix](file:///C:/Users/bahma/PycharmProjects/Projet%20solo/Double_scenario_Project/backend/api/animetix/templates/animetix) (except `admin/`)

- [ ] **Étape 1 : Supprimer les dossiers de templates et layouts legacy**
  Supprimer les répertoires physiques obsolètes sous `backend/api/animetix/templates/animetix/` :
  * `akinetix/`
  * `animinator/`
  * `archetypist/`
  * `audio/`
...
- [ ] **Étape 2 : Confirmer la conservation d'index.html principal et admin/**
  S'assurer que :
  * `backend/api/animetix/templates/index.html` est bien présent et intact.
  * `backend/api/animetix/templates/animetix/admin/` est bien conservé.
