...
- [x] **Mode Hors-ligne du Lecteur Manga (PWA) :** Permettre le téléchargement local des chapitres pour une lecture hors-ligne via Service Workers et IndexedDB/Cache API.
