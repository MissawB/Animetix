...
- [ ] **Plafonds budgétaires Cloud Run** (Priorité : BASSE) : Définir des limites de budget mensuel (Budget Caps) au niveau des services Cloud Run (notamment pour l'inférence GPU L4) afin de bloquer les dérives de facturation accidentelles ou malveillantes.
