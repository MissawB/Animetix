...
- [ ] **Améliorations SOTA 2026 de la Base d'Entraînement SFT :**
  - **Dialogues Multi-Tours (Multi-turn)** : Intégrer ~15-20% de scénarios de dialogues à plusieurs tours pour apprendre au modèle à suivre le contexte sur plusieurs messages consécutifs.
  - **Persona & Refus (Negative Examples)** : Ajouter des exemples de requêtes hors-sujet avec refus poli pour cadrer l'expertise exclusive du modèle sur l'univers anime/manga.
