...
- [ ] **Génération Structurée** : Remplacer l'heuristique de regex de parsing JSON par une validation de schéma native via `Instructor` avec Pydantic dans `UnifiedInferenceAdapter` et `FallbackInferenceAdapter` pour Ollama/OpenAI.
