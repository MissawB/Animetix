...
- [x] **~~Backend — module `dpo_feedback_loop` en double (core vs pipeline)~~** _(audit dette 2026-07-11)_
...
- [x] **~~Frontend — extraire un hook `useSSE` partagé~~** _(audit dette 2026-07-11)_
...
- [x] **~~Backend — config hardcodée à externaliser~~** _(audit dette 2026-07-11)_
