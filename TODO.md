...
- [x] **~~Tests frontend — gate de couverture cosmétique (~29 %)~~** _(audit dette 2026-07-11 ; rehaussé le 2026-07-16)_
...
- [x] **~~Frontend — composants > 500 lignes~~** _(audit dette 2026-07-11 ; BlindtestPage découpé le 2026-07-16)_
  - [BlindtestPage.tsx](frontend/src/pages/games/BlindtestPage.tsx) réduit de 753 lignes à 324 lignes en extrayant : sa logique d'état et ses gestionnaires dans un hook personnalisé [useBlindtestGame.ts](frontend/src/pages/games/hooks/useBlindtestGame.ts) ; le lecteur vidéo/audio dans [BlindtestPlayer.tsx](frontend/src/pages/games/components/BlindtestPlayer.tsx) ; et ses panels de fin de manche dans [BlindtestSecretReveal.tsx](frontend/src/pages/games/components/BlindtestSecretReveal.tsx) et [BlindtestBonusRecap.tsx](frontend/src/pages/games/components/BlindtestBonusRecap.tsx). Les autres composants de taille supérieure à 500 lignes (TransparencyPage, AudioLabPage...) restent à découper au fil de l'eau.
