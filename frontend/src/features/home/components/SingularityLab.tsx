  ...
  return (
    <section className="py-16 text-left">
      ...
      <Link to="/lab/" className="block no-underline group">
        <div className="relative w-full h-[280px] bg-[#0F1016] rounded-2xl overflow-hidden shadow-2xl border border-[#F4F1E8]/10 group-hover:border-[#5D7FD3]/50 transition-all duration-500 flex items-center p-8 md:p-16">
