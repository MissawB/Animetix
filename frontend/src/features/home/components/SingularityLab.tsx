  ...
  return (
    <section className="py-24 text-center border-t border-black/5 dark:border-white/5">
      <div className="max-w-4xl mx-auto space-y-8">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-red-600/10 text-red-700 dark:text-red-400 text-[10px] font-black uppercase tracking-widest mb-4">
        ...
        <p className="text-lg md:text-xl font-bold text-gray-600 dark:text-gray-400 uppercase tracking-[0.3em] leading-relaxed italic">
