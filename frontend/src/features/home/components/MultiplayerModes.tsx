...
export const MultiplayerModes: React.FC = () => {
  ...
  return (
    <section className="px-6 md:px-10 py-16 bg-[#f1f3f5] dark:bg-[#14161D] rounded-[3rem] border border-black/5 dark:border-[#F4F1E8]/10 text-left">
        ...
        {modesMulti.map((mode) => (
          ...
          >
            <div className="z-10 max-w-[60%]">
              <h3 className="text-black text-4xl font-black italic tracking-tighter manga-font leading-none">
                {mode.titre}
              </h3>
              <p className="text-black/70 text-xs font-bold uppercase tracking-widest mt-4 leading-relaxed">
                {mode.description}
              </p>
            </div>
            <img
