      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
        ...
        <div className="lg:col-span-1 space-y-8">
            ...
            <Card padding="lg" className="bg-gray-900 text-white/40 border-white/5">
                <Sparkles className="w-12 h-12 mb-4 text-yellow-400 opacity-20" />
                <p className="text-xs font-bold leading-relaxed italic">
                    Utilise l'algorithme <b>FateZero (SOTA 2026)</b> pour appliquer un transfert de style temporel cohérent. Contrairement au filtrage classique, l'IA reconstruit chaque frame en conservant la structure 3D.
                </p>
            </Card>
        </div>
        ...
        <div className="lg:col-span-3">
            <div className="bg-black rounded-[4rem] shadow-2xl overflow-hidden min-h-[600px] relative border-4 border-white/5 flex items-center justify-center p-4">
                {mutation.isPending && (
