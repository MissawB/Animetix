  ...
  return (
    <AnimatedPage>
      <div className="max-w-7xl mx-auto px-6 py-12 flex flex-col min-h-[calc(100vh-100px)]">
        ...
        <Card
          padding="lg"
          className="mb-12 bg-navy-950/50 border-white/5 shadow-2xl rounded-[3rem]"
        >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 flex-grow">
          ...
          <div className="lg:col-span-5 flex flex-col h-full min-h-[500px]">
            <div className="flex items-center justify-between mb-6 px-4">
              ...
              {isStreaming && (
                <Badge variant="primary" className="bg-blue-600 animate-pulse text-[8px]">
                  ACTIVE REASONING
                </Badge>
              )}
            </div>
            ...
            <Card
              padding="none"
              className="flex-grow bg-black border-white/5 rounded-[2.5rem] overflow-hidden relative"
            >
          ...
          <div className="lg:col-span-7 flex flex-col h-full">
            ...
            <Card
              padding="none"
              className="flex-grow bg-black border-white/10 shadow-[0_0_100px_rgba(0,0,0,0.8)] overflow-hidden rounded-[3rem] relative flex flex-col"
            >
              ...
              <div className="p-12 overflow-y-auto flex-grow prose prose-invert max-w-none">
                ...
                {!error && !finalAnswer && !isStreaming && (
                  <div className="h-full flex flex-col items-center justify-center opacity-10 text-center py-32">
                    ...
                    <h3 className="text-3xl font-black italic manga-font uppercase mb-4">
