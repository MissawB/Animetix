...
import { Target, Zap, Brain, GitBranch, RefreshCw, ShieldCheck, Sparkles } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <header className="mb-16 relative">
          ...
          <p className="text-xl font-bold opacity-30 uppercase tracking-[0.3em] max-w-2xl leading-relaxed">
            Visualisez la convergence de l'équilibre de Nash via la minimisation du regret
            contrefactuel (CFR).
          </p>
        </header>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-4 space-y-8">
            <Card
              padding="lg"
              className="bg-navy-950/50 border-white/10 rounded-[3rem] shadow-2xl relative overflow-hidden"
            >
              ...
              <div className="space-y-8">
                ...
                <div className="p-6 bg-white/5 rounded-3xl border border-white/5">
                  <h4 className="text-[10px] font-black uppercase tracking-widest mb-4 opacity-30">
                    Algorithme
                  </h4>
                  <div className="flex items-center gap-3">
                    <Badge
                      variant="neutral"
                      className="bg-red-500/10 text-red-500 border-none text-[8px] uppercase"
                    >
                      CFR+
                    </Badge>
                    <Badge
                      variant="neutral"
                      className="bg-blue-500/10 text-blue-500 border-none text-[8px] uppercase"
                    >
                      Regret Matching
                    </Badge>
                  </div>
            ...
            <Card padding="lg" className="bg-white/5 border-white/5 rounded-[2rem]">
              ...
              <p className="text-[11px] font-bold leading-relaxed opacity-40 uppercase italic">
                Le "Counterfactual Regret Minimization" est l'algorithme utilisé pour résoudre les
                jeux à information incomplète. Il permet à l'IA d'apprendre de ses erreurs passées
                en calculant le "regret" de ne pas avoir posé une meilleure question.
              </p>
            </Card>
          </div>
            ...
            <AnimatePresence mode="wait">
              {!result && !mutation.isPending && (
                ...
                >
                  ...
                  <h3 className="text-2xl font-black italic manga-font uppercase opacity-10">
              ...
              {mutation.isPending && (
                <div className="h-full min-h-[600px] flex flex-col items-center justify-center space-y-8">
                  ...
                  <p className="text-sm font-black uppercase tracking-[0.4em] text-red-500 animate-pulse">
                    Minimizing Regret...
                  </p>
                </div>
              )}
                ...
                >
                  ...
                  <section>
                    <div className="flex items-center justify-between mb-8">
                      <h2 className="text-2xl font-black italic manga-font uppercase tracking-tighter">
                        Convergence de <span className="text-red-500">Nash</span>
                      </h2>
                      <Badge
                        variant="neutral"
                        className="bg-white/5 border-none text-[8px] uppercase tracking-widest"
                      >
                  ...
                  <section>
                    <div className="flex items-center justify-between mb-8">
                      <h2 className="text-2xl font-black italic manga-font uppercase tracking-tighter text-blue-500">
                        Regret <span className="text-white/20">Matching</span>
                      </h2>
                      <Badge
                        variant="neutral"
                        className="bg-blue-500/10 text-blue-500 border-none text-[8px] uppercase tracking-widest"
                      >
                        ÉVOLUTION DU REGRET
                      </Badge>
                    </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                      ...
                      <div className="space-y-4">
                        {result.questions.map((q: string, i: number) => (
                          ...
                          >
                            ...
                            <span className="text-xs font-black italic text-red-500">
                    ...
                    <Card
                      padding="lg"
                      className="bg-red-600 text-white border-none shadow-2xl rounded-[2rem] flex flex-col justify-center items-center text-center"
                    >
        ...
        <div className="mt-24 grid grid-cols-1 md:grid-cols-2 gap-8">
          <Card
            padding="lg"
            className="bg-white dark:bg-black/40 border-red-500/20 shadow-[0_0_50px_rgba(239,68,68,0.1)] relative overflow-hidden group"
          >
            ...
            <div className="space-y-4 relative z-10">
              <p className="text-xs font-bold uppercase tracking-wider text-black/60 dark:text-white/60 leading-relaxed">
                <span className="text-red-600 dark:text-red-400">Le Principe :</span> L'IA cherche
                la meilleure question à poser dans un jeu de devinettes. Réglez le nombre
                d'itérations avec le curseur, puis lancez la résolution.
              </p>
              <p className="text-xs font-bold uppercase tracking-wider text-black/60 dark:text-white/60 leading-relaxed">
                <span className="text-red-600 dark:text-red-400">Le Regret :</span> À chaque
                itération, l'algorithme mesure le "regret" de ne pas avoir choisi une autre option,
                puis ajuste sa stratégie pour le réduire.
              </p>
              <p className="text-xs font-bold uppercase tracking-wider text-black/60 dark:text-white/60 leading-relaxed">
                <span className="text-red-600 dark:text-red-400">La Convergence :</span> Quand les
                courbes se stabilisent, la stratégie n'évolue plus : l'IA a trouvé le meilleur
                dosage de probabilités entre les questions possibles.
              </p>
            </div>
          </Card>
          ...
          <div className="p-12 rounded-[4rem] bg-gradient-to-br from-red-600/10 to-transparent border border-black/5 dark:border-white/5 flex flex-col justify-center text-center">
            <p className="text-sm font-black uppercase tracking-[0.15em] italic leading-relaxed text-red-800/70 dark:text-red-200/60">
              Simulation de Counterfactual Regret Minimization (CFR+ avec regret matching) exécutée
              côté serveur : la stratégie moyenne converge vers un équilibre de Nash approché.{' '}
              <br />
              Les graphiques tracent la probabilité de chaque action et l'évolution du regret au fil
              des itérations — une visualisation pédagogique de théorie des jeux.
            </p>
          </div>
        </div>
      </div>
