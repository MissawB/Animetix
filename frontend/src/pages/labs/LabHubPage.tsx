        ...
        <div className="max-w-7xl mx-auto px-6 py-16 relative z-10">
                  ...
                  <div className="p-10 relative z-10 flex flex-col h-full justify-between">
                    ...
                    <div className="flex items-center justify-between mt-auto pt-8 border-t border-white/5">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-[9px] font-bold opacity-20 uppercase">
                          {lab.status}
                        </span>
                      </div>
                    </div>
          ...
          <div className="mb-12 flex items-center justify-between gap-4">
            <h2 className="text-4xl font-black italic manga-font uppercase tracking-tighter">
              FORGE{' '}
              <span className="text-orange-500">{t('lab_hub.section_creative', 'CRÉATIVE')}</span>
            </h2>
            <div className="h-px flex-1 bg-gradient-to-r from-orange-500/50 to-transparent" />
            <Link
              to="/forge-hub/"
              className="text-[10px] font-black uppercase tracking-widest text-orange-500 hover:text-white transition-colors flex items-center gap-2 group whitespace-nowrap"
            >
              {t('lab_hub.btn_creative_hub', 'ACCÉDER AU HUB COMPLET')}{' '}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-24">
            {translatedCreativeLabs.map((lab) => (
              <Link key={lab.id} to={lab.url} className="no-underline group">
                <Card
                  padding="none"
                  className="h-full bg-black/40 border-white/5 hover:border-orange-500/30 transition-all duration-500 overflow-hidden relative group"
                >
                  <div
                    className={`absolute inset-0 bg-gradient-to-br ${lab.bg} opacity-0 group-hover:opacity-100 transition-opacity duration-700`}
                  />
          ...
          <div className="mb-12 flex items-center justify-between gap-4">
            <h2 className="text-4xl font-black italic manga-font uppercase tracking-tighter">
              COGNITION{' '}
              <span className="text-purple-600">{t('lab_hub.section_cognition', 'CORE')}</span>
            </h2>
            <div className="h-px flex-1 bg-gradient-to-r from-purple-600/50 to-transparent" />
            <Link
              to="/cognition-hub/"
              className="text-[10px] font-black uppercase tracking-widest text-purple-400 hover:text-white transition-colors flex items-center gap-2 group whitespace-nowrap"
            >
              {t('lab_hub.btn_cognition_hub', 'ACCÉDER AU HUB COMPLET')}{' '}
              <ArrowRight className="w-3 h-3 group-hover:translate-x-1 transition-transform" />
            </Link>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-24">
            {translatedCognitionLabs.map((lab) => (
              <Link key={lab.id} to={lab.url} className="no-underline group">
                <Card
                  padding="none"
                  className="h-full bg-black/40 border-white/5 hover:border-purple-600/30 transition-all duration-500 overflow-hidden relative group"
                >
                  <div
                    className={`absolute inset-0 bg-gradient-to-br ${lab.bg} opacity-0 group-hover:opacity-100 transition-opacity duration-700`}
                  />
