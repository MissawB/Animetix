                  ...
                  <Card padding="lg" className="bg-navy-950/50 border-white/10 rounded-[3rem] shadow-2xl overflow-hidden relative">
                      ...
                      <div className="space-y-8">
                          ...
                          <div className="space-y-4">
                            ...
                            <Button 
                              variant="outline"
                              onClick={() => navigate('/lab/multiverse-gallery/')}
                      ...
                      {synthesizedResult ? (
                          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-8">
                              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                  {[
                                      { label: 'Cohérence (IA)', val: synthesizedResult.evaluation?.ai_score || 0, threshold: 0.7 },
                                      { label: 'Immersion Score', val: synthesizedResult.evaluation?.community_score || 0, threshold: 0.7 }
                                  ].map(s => (
          ...
          <div className="mt-24 grid grid-cols-1 md:grid-cols-2 gap-8">
              <Card padding="lg" className="bg-black/40 border-red-500/20 shadow-[0_0_50px_rgba(220,38,38,0.1)] relative overflow-hidden group">
                  ...
                  <h4 className="text-xl font-black italic manga-font uppercase mb-4 flex items-center gap-3">
                      <Sparkles className="w-5 h-5 text-red-400" /> Guide du Multivers
                  </h4>
                  <div className="space-y-4 relative z-10">
                      <p className="text-xs font-bold uppercase tracking-wider text-white/60 leading-relaxed">
                          <span className="text-red-400">Synthèse Narrative :</span> Cette IA ne se contente pas d'écrire une histoire. Elle génère un univers complet avec ses personnages, ses règles de cohérence et sa chronologie propre.
                      </p>
                      <p className="text-xs font-bold uppercase tracking-wider text-white/60 leading-relaxed">
                          <span className="text-red-400">Cohérence ADMS :</span> L'algorithme vérifie que chaque élément (personnage, événement) est compatible avec les lois fondamentales du genre choisi pour éviter les incohérences de lore.
                      </p>
                      <p className="text-xs font-bold uppercase tracking-wider text-white/60 leading-relaxed">
                          <span className="text-red-400">Persistance Graphe :</span> Une fois validé, votre univers est injecté dans notre base de données graphe (Neo4j), lui permettant d'évoluer et d'interagir avec d'autres segments créés par la communauté.
                      </p>
                  </div>
              </Card>
              ...
              <div className="p-12 rounded-[4rem] bg-gradient-to-br from-red-600/10 to-transparent border border-white/5 flex flex-col justify-center text-center">
                  <p className="text-[10px] font-black uppercase tracking-[0.4em] opacity-30 italic leading-relaxed text-red-200/40">
                      Protocole Genesis : Les segments de réalité synthétique sont générés par consensus narratif. <br />
                      L'exportation vers la Galerie est soumise à la vérification d'intégrité diégétique.
                  </p>
              </div>
          </div>
        </div>
