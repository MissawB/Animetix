        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <div className="lg:col-span-8 space-y-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 flex-1">
                    <div className="flex flex-col space-y-4">
                        ...
                        <div className="relative flex-1 group">
                            <textarea 
                                ...
                                className="w-full h-full min-h-[450px] bg-navy-950 border border-white/10 rounded-[2.5rem] p-10 font-mono text-sm text-green-400 focus:outline-none focus:border-red-500 transition-all custom-scrollbar" 
                            />
                    ...
                    <div className="bg-white/5 rounded-[2.5rem] border border-white/5 p-10 flex flex-col justify-between shadow-2xl relative overflow-hidden">
                                    ...
                                    >
                                        ...
                                        <div className="bg-navy-950/80 p-8 rounded-3xl border border-white/5">
                                            ...
                                            <code className="text-xs font-mono text-yellow-400 block break-all">
                                                {compilerResult.c_code_generated}
                                            </code>
                                        </div>
                                    </motion.div>
                                ) : (
