        ...
        <div className="mt-24 grid grid-cols-1 md:grid-cols-2 gap-8">
            <Card padding="lg" className="bg-white dark:bg-black/40 border-blue-500/20 shadow-[0_0_50px_rgba(59,130,246,0.1)] relative overflow-hidden group">
                ...
                <h4 className="text-xl font-black italic manga-font uppercase mb-4 flex items-center gap-3">
                    <Sparkles className="w-5 h-5 text-blue-600 dark:text-blue-400" /> Guide Spatial
                </h4>
                <div className="space-y-4 relative z-10">
                    <p className="text-xs font-bold uppercase tracking-wider text-black/60 dark:text-white/60 leading-relaxed">
                        <span className="text-blue-600 dark:text-blue-400">L'Image Source :</span> Chargez n'importe quelle image 2D (personnage, décor, objet). C'est le point de départ de toute l'analyse.
                    </p>
                    <p className="text-xs font-bold uppercase tracking-wider text-black/60 dark:text-white/60 leading-relaxed">
                        <span className="text-blue-600 dark:text-blue-400">La Profondeur :</span> L'IA estime la distance de chaque pixel et produit une carte de profondeur, comme si elle voyait le relief de l'image.
                    </p>
                    <p className="text-xs font-bold uppercase tracking-wider text-black/60 dark:text-white/60 leading-relaxed">
                        <span className="text-blue-600 dark:text-blue-400">Le Modèle 3D :</span> En un clic, l'image devient un objet 3D complet que vous pouvez faire tourner à la souris et retrouver dans votre galerie.
                    </p>
                </div>
            </Card>
            ...
            <div className="p-12 rounded-[4rem] bg-gradient-to-br from-blue-600/10 to-transparent border border-black/5 dark:border-white/5 flex flex-col justify-center text-center">
                <p className="text-sm font-black uppercase tracking-[0.15em] italic leading-relaxed text-blue-800/70 dark:text-blue-200/60">
                    Estimation de profondeur monoculaire et reconstruction 3D (maillage GLB, Gaussian Splatting) à partir d'une seule image. <br />
