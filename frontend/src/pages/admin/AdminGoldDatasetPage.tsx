        ...
        <div className="max-w-7xl mx-auto px-6 py-16">
          ...
          {!entries || entries.length === 0 ? (
              ...
              <div className="space-y-8">
                  {entries.map((entry) => (
                      <Card key={entry.id} padding="none" className={`overflow-hidden bg-white dark:bg-[#0f0f1a] border-none shadow-xl relative ${entry.is_validated ? 'border-l-4 border-emerald-500' : 'hover:scale-[1.01]'} transition-all duration-300`}>
                          <div className="p-8 grid grid-cols-1 lg:grid-cols-12 gap-8 text-black dark:text-white">
                              {/* Metadata */}
                              ...
                              <div className="lg:col-span-8 space-y-6">
                                  <div>
                                      ...
                                      <div className="p-4 bg-gray-50 dark:bg-black/20 rounded-xl border border-black/5 dark:border-white/5 text-xs font-medium opacity-80 leading-relaxed italic">
                                  ...
                                  <div>
                                      ...
                                      <div className="p-6 bg-emerald-500/5 rounded-2xl border border-emerald-500/10 text-sm font-bold leading-relaxed">
                                          {entry.response}
                                      </div>
                                  </div>
                              </div>
          ...
          {/* Legend Box */}
          <div className="mt-24 p-12 rounded-[4rem] bg-white dark:bg-[#0f0f1a] shadow-2xl border border-black/5 dark:border-white/5 flex flex-col md:flex-row items-center gap-12 text-black dark:text-white">
