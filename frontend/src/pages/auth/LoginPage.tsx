...
const LoginPage: React.FC = () => {
  ...
  // Social sign-in (Google/Discord/X/MAL) is not wired up yet — show the buttons
  // disabled rather than triggering a popup that always fails.
  const socialBtn =
          ...
          <div className="w-full max-w-md animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="grid grid-cols-4 gap-3">
                <button type="button" aria-label="Google — bientôt disponible" title="Bientôt disponible" disabled className={socialBtn}>
                ...
                <button type="button" aria-label="Discord — bientôt disponible" title="Bientôt disponible" disabled className={socialBtn}>
                ...
                <button type="button" aria-label="X — bientôt disponible" title="Bientôt disponible" disabled className={socialBtn}>
                  <svg className="w-5 h-5 text-black dark:text-white" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                  </svg>
                </button>

                <button type="button" aria-label="MyAnimeList — bientôt disponible" title="Bientôt disponible" disabled className={socialBtn}>
