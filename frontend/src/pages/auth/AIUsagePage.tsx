  ...
  if (!usageData) {
    return (
      <div className="p-20 text-center">
        ...
        <p className="font-bold">Impossible de charger les données d'utilisation.</p>
      </div>
    );
  }
      ...
      <div className="min-h-screen bg-[#fffcf0] dark:bg-[#0f0f1a] transition-colors duration-500 bg-manga-overlay pb-20">
        <div className="max-w-6xl mx-auto px-6 py-16">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-12 gap-6">
            <div>
              <h1 className="text-4xl md:text-5xl font-black italic manga-font tracking-tighter uppercase flex items-center gap-3 text-black dark:text-white">
                <LayoutDashboard className="w-10 h-10 text-blue-500" /> QUOTAS <span className="text-blue-500">IA</span>
              </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            ...
            <Card padding="lg" className="bg-white dark:bg-[#161625] border-none shadow-xl relative overflow-hidden group">
              ...
              <div className="relative z-10">
                <span className="text-[10px] font-black uppercase text-gray-400 tracking-[0.2em] block mb-4">Consommation Berrix (Bx)</span>
                ...
                <span className="text-[10px] font-bold text-blue-500 uppercase">{usage_today.tokens_percent}% utilisé aujourd'hui</span>
              </div>
            </Card>
            ...
            <Card padding="lg" className="bg-white dark:bg-[#161625] border-none shadow-xl relative overflow-hidden group">
              ...
              <div className="relative z-10">
                <span className="text-[10px] font-black uppercase text-gray-400 tracking-[0.2em] block mb-4">Requêtes API</span>
                <div className="flex items-baseline gap-2 mb-2">
                ...
                <span className="text-[10px] font-bold text-emerald-500 uppercase">{usage_today.requests_percent}% des appels consommés</span>
              </div>
            </Card>
            ...
            <Card padding="lg" className="bg-white dark:bg-[#161625] border-none shadow-xl relative overflow-hidden group">
              ...
              <div className="relative z-10">
                <span className="text-[10px] font-black uppercase text-gray-400 tracking-[0.2em] block mb-4">Coût Estimé (Valeur)</span>
                <div className="flex items-baseline gap-2 mb-2">
          ...
          <div className="mt-12 p-8 rounded-[2rem] bg-blue-500/5 border border-blue-500/10 flex flex-col md:flex-row items-center gap-8">
            ...
            <div>
              <h4 className="text-lg font-black italic manga-font uppercase mb-1 text-black dark:text-white">Réinitialisation des Quotas</h4>
