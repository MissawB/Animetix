        ...
        <div className="max-w-3xl w-full relative">
          ...
          <div className="bg-white/80 dark:bg-anime-dark-card/80 backdrop-blur-2xl rounded-[4rem] p-12 shadow-2xl border border-white/20 relative z-10 text-center overflow-hidden">
            <div className="absolute top-0 left-0 w-full h-2 bg-black/5 dark:bg-white/5">
              <div
                className="h-full bg-yellow-400 animate-[loading_2s_ease-in-out_infinite]"
                style={{ width: '30%' }}
              />
            </div>
            ...
            <h2 className="text-5xl font-black italic manga-font mb-6 tracking-tight">
            ...
            <div className="flex justify-center items-center gap-12 mb-12">
              <div className="group relative">
                ...
                {itemA?.image_url ? (
                  <img
                    src={itemA.image_url}
                    className="w-28 h-40 object-cover rounded-2xl shadow-xl relative z-10 grayscale brightness-50"
                    alt=""
                    loading="lazy"
                    decoding="async"
                  />
                ...
                <p className="mt-3 text-[10px] font-black uppercase opacity-40 max-w-[112px] truncate">
                  ...
                  <div className="relative h-[300px] w-full flex items-center justify-center overflow-hidden select-none">
                    ...
                    <AnimatePresence initial={false} custom={styleDir} mode="popLayout">
                      ...
                      >
                        ...
                        <span className="absolute top-3 left-3 bg-yellow-400 text-black text-[10px] font-black px-2.5 py-1 rounded-full uppercase tracking-tighter shadow pointer-events-none">
                          {idx + 1}/{len}
                        </span>
                        <div className="absolute bottom-0 inset-x-0 p-4 text-left pointer-events-none">
                          <div className="text-xl font-black italic uppercase text-white leading-none mb-1 drop-shadow-md">
                            {current.name}
                          </div>
