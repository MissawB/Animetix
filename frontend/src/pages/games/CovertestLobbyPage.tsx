  ...
  const DIFFICULTIES: {
    ...
    () => [
      ...
      },
      {
        ...
        tries: 4,
        active: 'border-yellow-500 bg-yellow-500/10 text-yellow-600 dark:text-yellow-400',
      },
      {
        key: 'Hard',
      ...
      <Card padding="lg" className="space-y-10">
            ...
            {[
              {
                ...
                sub: t('games.covertest.lobby.mode_session_sub', 'Enchaîne plusieurs couvertures'),
              },
              {
                key: 'single' as Mode,
                icon: ImageIcon,
              ...
              >
                ...
                <span className="text-[11px] font-bold uppercase tracking-widest text-gray-400 text-center">
                  {sub}
                </span>
              </button>
            ))}
        ...
        <div>
          ...
          <DifficultySelector
            ...
            hoverClassName="hover:border-yellow-400/50"
          />
        </div>
        ...
        <div>
          ...
          <p className="text-[11px] text-gray-400 mb-4">
            ...
            <span className="font-bold">{t('games.covertest.lobby.origin_auto', 'Auto')}</span>{' '}
            {t(
          ...
          <div className="space-y-3">
            {[
              ...
              >
                ...
                <span
                  className={`shrink-0 w-11 h-6 rounded-full p-0.5 transition-colors ${on ? 'bg-yellow-400' : 'bg-black/15 dark:bg-white/15'}`}
                >
                  <span
