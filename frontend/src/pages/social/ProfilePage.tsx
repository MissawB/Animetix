                ...
                <div className="text-center md:text-left">
                  ...
                  <div className="flex flex-wrap justify-center md:justify-start gap-4">
                    ...
                    >
                      ...
                      {t('social.profile.rank', { rank: profile.rank || 'Explorateur' })}
                    </Badge>
                    <Badge
                      variant="neutral"
                    ...
                    >
                      ...
                      {t('social.profile.level', { level: profile.level })}
                    </Badge>
            ...
            <div className="p-12 text-black dark:text-white">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
                ...
                <StatCard
                  ...
                  value={profile.achievements_count || 0}
                  icon={<Award className="text-yellow-500" />}
                />
                <StatCard
                  label={t('social.profile.collection')}
                  value={profile.collection_count || 0}
                  ...
                  <div className="space-y-4">
                    ...
                    {(!profile.recent_achievements || profile.recent_achievements.length === 0) && (
                      <p className="text-center py-8 opacity-20 italic">
                        {t(
                          'social.profile.no_achievements',
                      ...
                      <div className="mt-4">
                        {connections?.some((c) => c.tracker === 'myanimelist') ? (
                          ...
                          >
                            ...
                            {t('social.profile.unlink', 'Dissocier')}
                          </button>
                        ) : (
                          <button
                          ...
                          >
                            ...
                            {t('social.profile.link_mal', 'Associer MAL')}
                          </button>
                        )}
                      </div>
                    </div>
                  ...
                  {linkingTracker && (
                    <div className="mt-8 p-6 bg-white/50 dark:bg-black/30 rounded-2xl border border-blue-500/30">
                      <div className="flex items-center justify-between mb-4">
                        ...
                        <button
                          onClick={() => setLinkingTracker(null)}
                          className="text-gray-400 hover:text-white text-xs border-none bg-transparent cursor-pointer font-bold"
                        >
                      ...
                      <form onSubmit={handleLinkSubmit} className="space-y-4">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          ...
                          <div className="flex flex-col gap-1.5">
                            ...
                            <input
                              ...
                              required
                              placeholder={t(
                                'social.profile.token_placeholder',
                        ...
                        {linkError && (
                          <p className="text-[10px] text-red-400 font-bold">{linkError}</p>
                        )}
                        <button
                          type="submit"
