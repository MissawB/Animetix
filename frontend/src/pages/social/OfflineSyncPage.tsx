    ...
    <AnimatedPage>
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <header className="mb-12">
          <Link
            to="/social/dashboard/"
            className="inline-flex items-center gap-2 text-xs font-black uppercase tracking-widest opacity-40 hover:opacity-100 transition-opacity mb-8 no-underline text-current"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
          <Card
            padding="md"
            className="flex items-center justify-between bg-[#1a1a2e]/60 border-white/5"
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-[10px] font-black uppercase opacity-40 m-0">
        ...
        {syncResult && (
          <div className="p-6 bg-green-500/10 border border-green-500/30 text-green-500 rounded-2xl mb-10">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-lg font-black uppercase italic m-0">
            ...
            <div className="grid grid-cols-3 gap-4 text-center mt-2">
              <div className="bg-green-500/5 p-4 rounded-xl border border-green-500/10">
                <p className="text-[10px] uppercase font-bold opacity-60 m-0">
                  {t('social.offline.synced_items', 'Parties synchronisées')}
                </p>
                <p className="text-2xl font-black italic manga-font m-0">
        ...
        <Card padding="none" className="bg-[#1a1a2e]/30 border-white/5 overflow-hidden">
          <div className="p-6 border-b border-white/5">
            <h2 className="text-lg font-black uppercase italic m-0">
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="border-b border-white/5 bg-white/5">
                  <th className="p-4 text-[10px] uppercase font-black tracking-wider opacity-60">
              ...
              <tbody>
                {offlineGames.map((game, i) => (
                  ...
                  >
                    ...
                    <td className="p-4 text-xs">
                      <span
                        className={`font-black italic ${game.score === 100 ? 'text-green-500' : 'text-yellow-500'}`}
                      >
                        {game.score} / 100
                      </span>
                    </td>
                ...
                {offlineGames.length === 0 && (
                  <tr>
                    <td
                      colSpan={5}
                      className="p-16 text-center opacity-30 text-xs uppercase font-bold tracking-widest"
                    >
                      {t(
