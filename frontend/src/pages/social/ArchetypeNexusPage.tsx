        ...
        <div className="max-w-7xl mx-auto px-6 py-12 relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-12">
            ...
            <div className="lg:col-span-4 space-y-8">
              <Card
                padding="none"
                className="bg-black border-white/10 overflow-hidden rounded-[3rem] relative group shadow-2xl"
              >
                ...
                <div className="relative z-10 p-10 text-center">
                  <div className="w-48 h-48 mx-auto mb-8 relative">
                    ...
                    <div className="w-full h-full bg-navy-900 border-4 border-white/10 rounded-full flex items-center justify-center relative overflow-hidden">
                      ...
                      <div className="absolute bottom-0 left-0 w-full bg-gradient-to-t from-blue-500/20 to-transparent h-1/2 animate-scan" />
                    </div>
                  </div>
                  ...
                  <h2 className="text-4xl font-black italic manga-font uppercase mb-2 tracking-tighter">
                    {t('social.nexus.master_archetype', 'Archétype Maître')}
                  </h2>
                ...
                <div className="border-t border-white/5 bg-white/5 p-8 grid grid-cols-2 gap-4">
                  ...
                  <div className="text-center border-l border-white/5">
                    ...
                    <p className="text-xl font-black italic text-emerald-500">
              ...
              <Card padding="lg" className="bg-navy-900/40 border-white/5">
                <h3 className="text-xs font-black uppercase opacity-40 mb-8 tracking-widest flex items-center gap-2">
                  ...
                  {t('social.nexus.neural_profile', 'Profil Neuronal')}
                </h3>
            ...
            <div className="lg:col-span-8 space-y-8 flex flex-col">
              ...
              <Card
                padding="lg"
                className="bg-black border-white/5 overflow-hidden flex-grow flex flex-col"
              >
                <header className="flex justify-between items-center mb-6">
                  ...
                  <Badge
                    variant="neutral"
                    className="bg-emerald-500/10 text-emerald-500 border-emerald-500/20 text-[8px]"
                  >
                    TIME-SERIES ALPHA
                  </Badge>
                </header>
              ...
              <Card
                padding="lg"
                className="bg-black border-blue-500/20 shadow-[0_0_40px_rgba(59,130,246,0.1)]"
              >
                <header className="flex justify-between items-start mb-6">
                  <div>
                    ...
                    <p className="text-[10px] font-bold opacity-30 uppercase tracking-widest">
                      {t(
                        'social.nexus.z3_desc',
                        'Contraintes formelles déduites de vos interactions.',
                      )}
                    </p>
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {logical_rules.map((rule: string, i: number) => (
                    ...
                    >
                      ...
                      <code className="text-xs font-bold text-blue-100 opacity-80 uppercase tracking-wider">
                        {rule}
                      </code>
                    </motion.div>
                  ))}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-1 gap-8">
            ...
            <Card padding="lg" className="bg-navy-900/40 border-white/5">
              <h3 className="text-xs font-black uppercase opacity-40 mb-10 tracking-widest flex items-center gap-2">
                ...
                {t('social.nexus.episodic_memory', 'Signaux de Mémoire Épisodique')}
              </h3>
              <div className="space-y-6 relative">
                ...
                {recent_signals.map((sig, i) => (
                  <div key={i} className="flex gap-6 relative group">
                    <div
                      className={`w-10 h-10 rounded-2xl shrink-0 flex items-center justify-center relative z-10 transition-transform group-hover:scale-110 ${
                        sig.is_positive
                    ...
                    <div className="flex-grow pt-2">
                      <div className="flex justify-between items-center mb-1">
                        <p
                          className={`text-[10px] font-black uppercase tracking-widest ${sig.is_positive ? 'text-emerald-400' : 'text-red-400'}`}
                        >
                          {sig.is_positive
                      ...
                      <p className="text-sm font-bold opacity-80 line-clamp-1 italic group-hover:line-clamp-none transition-all">
                        "{sig.context}"
                      </p>
                    </div>
                  </div>
