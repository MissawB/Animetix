  ...
  const modesSolo = [
    {
      ...
      icon_url: '/img/modes/akinetix.png',
    ...
    },
    {
      ...
      icon_url: '/img/modes/classic.png',
    ...
    },
    {
      ...
      icon_url: '/img/modes/paradox.png',
    ...
    },
    {
      ...
      description: isEn 
        ...
        : "Reconstituez les couvertures de mangas floutées ou mélangées par l'IA.",
      icon_url: '/img/modes/visionquest.png',
    ...
    },
    {
      ...
      icon_url: '/img/modes/animinator.png',
  ...
  const modesMulti = [
    {
      ...
      icon_url: '/img/modes/undercover.png',
      url: '/game/duel/lobby/',
    },
    {
      titre: 'Code Manga',
      ...
      icon_url: '/img/modes/codemanga.png',
      url: '/game/duel/lobby/',
    },
  ];
  ...
  return (
    <AnimatedPage>
      <div className="w-full bg-transparent transition-colors duration-500 bg-manga-overlay">
        ...
        {/* CONTENT WRAPPER WITH WHITE BACKGROUND IN LIGHT MODE */}
        <div className="max-w-[1600px] mx-auto px-6 md:px-10 pb-20 mt-12 bg-white dark:bg-navy-800 rounded-[3rem] shadow-xl border border-gray-100 dark:border-white/5 transition-colors duration-500">
