    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 relative">
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <label
            htmlFor="univers-alpha"
            className="text-[10px] font-black uppercase tracking-widest text-[#8F94A5]"
          >
          ...
          {itemA && (
            <button
              ...
              className="text-[10px] font-bold text-[#E8442B] hover:underline flex items-center gap-1"
            >
        ...
        <div className="h-[180px] relative overflow-hidden rounded-xl bg-[#0B0C10] border border-dashed border-[#F4F1E8]/15 flex items-center justify-center group transition-all">
          {itemA ? (
            <>
              <img
                src={itemA.image_url}
            ...
            <div className="text-center text-[#8F94A5] opacity-60 group-hover:opacity-100 transition-opacity">
              <div className="w-12 h-12 bg-[#F4F1E8]/5 rounded-xl flex items-center justify-center mx-auto mb-2">
      ...
      <div
        className="hidden md:flex absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-12 h-12 -rotate-3 items-center justify-center z-20 rounded-[3px] border-2 border-[#E8442B] bg-[#0B0C10] text-2xl font-bold leading-none text-[#E8442B] shadow-lg shadow-black/60"
        aria-hidden
      >
        鍛
      </div>
