...
def main():
    ...
    for rule in rules_config:
        ...
        check_rule = run_command([
            "gcloud", "compute", "security-policies", "rules", "describe", prio,
        ...
        cmd = [
            "gcloud", "compute", "security-policies", "rules", action, prio,
            f"--security-policy={policy_name}",
    ...
    print(f"gcloud compute backend-services update BACKEND_SERVICE_NAME --security-policy={policy_name} --global")
