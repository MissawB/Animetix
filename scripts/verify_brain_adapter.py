...
def verify_adapter():
    ...
    methods_to_check = [
        "generate", "stream_generate", "generate_image", "calculate_visual_similarity",
        "get_image_embedding", "classify_image", "detect_objects",
        "get_video_temporal_embeddings", "localize_video_actions",
        "transform_image_to_anime", "transform_video_to_anime",
        "generate_soundscape", "clone_voice", "speech_to_speech",
        "estimate_depth", "generate_3d_scene", "process_manga_page",
        "translate_manga_page", "inpaint_text_bubbles", "moderate_content",
        "generate_image_description", "get_diagnostics", "calculate_uncertainty",
        "health_check", "visual_rerank", "get_multimodal_late_interaction"
    ]
