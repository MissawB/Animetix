...
def benchmark_video_rag(results):
    ...
    try:
        ...
        results.append({'name': "Video Temporal RAG", 'status': f"SKIP ({str(e)})", 'latency_ms': 0, 'ram_mb': 0})
...
def main():
    ...
    parser.add_argument("--distill", action="store_true", help="Run Distillation benchmark")
