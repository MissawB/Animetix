...
def run_smoke_test():
    ...
    baseline_path = os.path.join(os.path.dirname(__file__), '..', 'data', 'mlops', 'baseline_ragas.json')
    ...
    if current_report.get('avg_faithfulness', 0) < baseline.get('avg_faithfulness', 0) - 0.05:
