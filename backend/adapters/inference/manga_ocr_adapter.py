...
class MangaOCRAdapter(InferencePort):
    ...
    def generate(
        ...
        **kwargs
        ...
        raise InferenceNotImplementedError("Text generation not supported by MangaOCRAdapter")
    ...
    def stream_generate(
        ...
        **kwargs
        ...
        raise InferenceNotImplementedError("Streaming generation not supported by MangaOCRAdapter")

    def get_text_embedding(self, text: str) -> List[float]:
        raise InferenceNotImplementedError("Text embedding not supported by MangaOCRAdapter")
