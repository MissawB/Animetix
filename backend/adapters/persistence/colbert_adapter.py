...
class LateInteractionColBERTAdapter:
    def __init__(self, model_name: str = "colbert-ir/colbertv2.0", dimension: int = 128):
    ...
    def calculate_maxsim(self, query_embeddings: np.ndarray, doc_embeddings: np.ndarray) -> float:
        """
    ...
    def rank_documents(self, query: str, documents: List[Dict], text_field: str = "description") -> List[Dict]:
        """
