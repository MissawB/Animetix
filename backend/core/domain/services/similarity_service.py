...
class SimilarityService:
    ...
    def _calculate_graph_similarity(self, media_type: str, id_a: str, id_b: str) -> float:
        """
        ...
        """
        direct_res = self.neo4j.execute_query(direct_query, {"id_a": str(id_a), "id_b": str(id_b)})
