...
class SoundscapeGenerationService:
    ...
    def __init__(
        ...
        video_service: VideoQuestService,
    ...
    def generate_soundscape_for_video(self, video_data: bytes) -> str:
        ...
        actions = self.inference_engine.localize_video_actions(
            video_data, ["combat", "pluie", "magie"]
        )
        ...
        return self.inference_engine.generate_soundscape(
            video_metadata=analysis, prompt=audio_prompt
        )
