...
class RoutingDecision(BaseModel):
    decision: str = Field(description="La classification de la requête: soit 'SIMPLE', soit 'COMPLEX'")
...
class SemanticRouter:
    ...
    def classify(self, query: str) -> str:
        ...
        try:
            ...
            logger.info(f"🚦 Semantic Router: Decision={decision.decision} for query='{query}' (Rationale: {decision.rationale})")
