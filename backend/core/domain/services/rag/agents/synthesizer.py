...
class ResponseSynthesizer:
    ...
    def synthesize_stream(self, query: str, context: str, thinking_budget: int = 0, thinking_mode: bool = False, use_slm: bool = False, correction_feedback: Optional[str] = None, language: str = "Français", xai_collector=None) -> Generator[str, None, None]:
