    ...
    def ready(self):
        ...
        container.wire(
            modules=[
                ...
                "animetix.api.games.vs_battle",
                "animetix.api.explore",
                "animetix.api.core.accounts",
                "animetix.api.core.config",
                "animetix.api.core.manga",
                "animetix.api.core.media",
                "animetix.api.core.suwayomi",
                "animetix.api.social",
                "animetix.api.labs.audio",
                "animetix.api.labs.dashboards",
                "animetix.api.labs.manga",
                "animetix.api.labs.singularity",
                "animetix.api.labs.spatial",
                "animetix.api.labs.video",
                "animetix.api.mlops",
                "animetix.api.graph",
                "animetix.api.cognition",
                "animetix.api.companion",
                "animetix.api.dependencies",
                "animetix.api.developer",
                "animetix.api.monitoring",
                "animetix.api.multiverse",
                "animetix.api.observability",
                "animetix.api.forge_vn",
                "animetix.api.streams",
                "animetix.middleware",
