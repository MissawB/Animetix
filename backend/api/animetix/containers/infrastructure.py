...
class InfrastructureContainer(containers.DeclarativeContainer):
    ...
    translation_service = providers.Singleton("core.domain.services.translation_service.TranslationService")
    ...
    pricing_service = providers.Singleton("core.domain.services.pricing_service.PricingService")
    ...
    web_search = providers.Singleton("adapters.persistence.web_search_adapter.UnifiedWebSearchAdapter")