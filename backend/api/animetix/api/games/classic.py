...
class ClassicGameGuessView(APIView):
    ...
    def post(self, request, catalog_service = Provide[Container.core.catalog_service], game_service = Provide[Container.core.game_service]):
        ...
        raw_sim = game_service.calculate_raw_similarity(media_type, secret_title, guess_title, data)
        ...
        # Get updated state
        revealed_hints = port.get('revealed_hints', [])
        hints = GamePresenter.format_classic_hints(secret_item, len(guesses), revealed_hints)
