...
class AkinetixRLStartView(APIView):
    ...
    def post(self, request, 
        ...
        usage_port.log_usage(engine="akinetix-rl-agent", units=10, user_id=request.user.id)
...
class AkinetixRLAnswerView(APIView):
    ...
    def post(self, request, 
        ...
        # Log usage
        usage_port.log_usage(engine="akinetix-rl-agent", units=5, user_id=request.user.id)
