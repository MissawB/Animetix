...
class PaymentRequired(APIException):
    status_code = 402
    default_detail = (
        "Fonds insuffisants. Veuillez recharger vos Berrix (Bx) dans la Power Station."
    )
...
class WalletMineView(APIView):
    ...
    def post(self, request):
        ...
        try:
            ...
            cache.set(
                cache_key, True, timeout=175
            )  # 175s pour être un peu plus souple que le setInterval frontend
