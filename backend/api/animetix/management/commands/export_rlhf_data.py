...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        output_dir = os.path.join(
            os.path.dirname(base_dir), "data", "mlops", "datasets"
        )
        ...
        self.stdout.write(
            self.style.SUCCESS(f"Exported feedback entries to {feedback_path}.")
        )
        ...
        self.stdout.write(
            self.style.SUCCESS(f"Exported gameplay sessions to {session_path}.")
        )
