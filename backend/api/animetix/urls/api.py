...
urlpatterns = [
    ...
    path('mlops/dpo/feedback-loop/', api_views.DPOFeedbackLoopView.as_view(), name='api_dpo_feedback_loop'),
    ...
    path('mlops/adapters/', api_views.AdaptersView.as_view(), name='api_mlops_adapters'),
    ...
    path('game/classic/start/', api_views.ClassicGameStartView.as_view(), name='api_classic_start'),
    path('game/classic/guess/', api_views.ClassicGameGuessView.as_view(), name='api_classic_guess'),
    path('game/classic/reveal/', api_views.ClassicGameRevealView.as_view(), name='api_classic_reveal'),
    path('cognition/archetype-nexus/', api_views.ArchetypeNexusView.as_view(), name='api_archetype_nexus'),
    path('cognition/neuro-memory/', api_views.NeuroMemoryManagementView.as_view(), name='api_neuro_memory'),
    path('cognition/debate-arena/', api_views.AIDebateArenaView.as_view(), name='api_debate_arena'),
    path('cognition/cove-oracle/', api_views.CoveOracleView.as_view(), name='api_cove_oracle'),
    path('cognition/cfr-strategy-lab/', api_views.CFRStrategyLabView.as_view(), name='api_cfr_strategy_lab'),
