...
def run_ingestion():
    ...
    for offset in range(0, 500, 50):
        ...
        query = (
            "fields name, summary, genres.name, themes.name, platforms.name, total_rating, total_rating_count, cover.url, first_release_date, similar_games.name, storyline; sort total_rating_count desc; limit 50; offset "
            + str(offset)
            + ";"
        )
