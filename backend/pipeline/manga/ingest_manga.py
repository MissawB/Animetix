...
def run_ingestion():
    ...
    logger.info(f"🚀 Starting Manga Ingestion from AniList (Incremental)...")
    ...
    if new_items_count > 0:
        ...
        logger.info(f"✅ Collection finished! Added {new_items_count} new mangas. Total: {len(all_mangas)}")
    else:
