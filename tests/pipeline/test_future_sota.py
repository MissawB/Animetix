...
def test_dspy_prompt_optimizer():
    ...
    best, score = optimizer.evaluate_and_select_best(
        "Original template: {query}", dataset
    )
...
def test_cfr_game_solver():
    from core.domain.services.cfr_game_solver import CFRGameSolver  # noqa: E402
...
def test_liquid_neural_network_simulator():
    ...
    continuous_signal = [[0.5, 0.2], [0.6, 0.1], [0.4, 0.3]]
