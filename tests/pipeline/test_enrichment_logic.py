                ...
                return_value=[
                    {
                        "id": 1,
                        "title": "Naruto",
                        "description": "L'histoire d'un jeune ninja qui veut devenir Hokage et de son rival Sasuke qui souhaite restaurer son clan. C'est une épopée légendaire de 500 épisodes qui commence au village de Konoha.",
                    }
                ],
            ):
