...
def test_generate_fusion_scenario_task(mocker):
    ...
    mock_llm_service.generate_fusion_scenario.return_value = {"scenario": "A fusion story"}
...
def test_generate_fusion_image_task(mocker):
    ...
    mocker.patch('animetix.tasks.generate_fusion_image', return_value="http://image.jpg")
