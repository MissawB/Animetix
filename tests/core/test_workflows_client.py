...
def test_workflows_client_trigger_and_status(mock_executions_client):
    ...
    mock_exec_response.name = (
        "projects/test-proj/locations/test-loc/workflows/test-wf/executions/exec-123"
    )
    ...
    client.parent = (
        "projects/test-proj/locations/europe-west1/workflows/manga-voice-pipeline"
    )
