...
def test_prompt_manager_moderator_loading():
    ...
    input_prompt, input_system = manager.get_prompt("input_moderator", categories="HATE_SPEECH, JAILBREAK", text="test query")
    ...
    output_prompt, output_system = manager.get_prompt("output_moderator", categories="SPOILER", text="test response")
