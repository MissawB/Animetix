...
def test_graph_entity_validation():
    entity = GraphEntity(name="Naruto Uzumaki", type="Personnage", description="Ninja de Konoha")
...
def test_graph_relation_validation():
    relation = GraphRelation(source="Naruto", target="Sasuke", relation="RIVAL_DE", description="Rivalité historique")
...
def test_graph_extraction_validation():
    extraction = GraphExtraction(
        ...
        relations=[GraphRelation(source="Naruto", target="Sasuke", relation="RIVAL_DE", description="Rivalité")]
    )
