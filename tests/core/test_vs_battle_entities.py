...
from core.domain.entities.ai_schemas import CombatStats, CombatCharacter, DebateTurn, CombatResult
...
def test_combat_result_instantiation():
    stats_a = CombatStats(tier="10-A", speed="Normal", durability="Normal", intelligence="Average", abilities=[])
    char_a = CombatCharacter(name="A", wiki_url="url_a", stats=stats_a, summary="summary_a")
    
    stats_b = CombatStats(tier="10-A", speed="Normal", durability="Normal", intelligence="Average", abilities=[])
    char_b = CombatCharacter(name="B", wiki_url="url_b", stats=stats_b, summary="summary_b")
