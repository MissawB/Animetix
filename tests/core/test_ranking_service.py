...
def test_streak_increment(ranking_service):
    ...
    profile = UserProfile(id=1, username="test", xp=0, current_streak=1, last_win_date=yesterday)
...
def test_streak_reset(ranking_service):
    ...
    profile = UserProfile(id=1, username="test", xp=0, current_streak=5, last_win_date=two_days_ago)
