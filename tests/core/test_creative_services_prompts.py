...
def test_fusion_service_uses_prompt_manager(mock_engine, mock_prompt_manager):
    service = FusionDomainService(inference_engine=mock_engine, prompt_manager=mock_prompt_manager)
...
def test_soundscape_uses_prompt_manager(mock_engine, mock_video_service, mock_prompt_manager):
    service = SoundscapeGenerationService(inference_engine=mock_engine, video_service=mock_video_service, prompt_manager=mock_prompt_manager)
