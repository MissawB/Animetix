...
def test_solve_riddle_with_star_success(mock_engine, mock_prompt_manager, mock_gold_dataset_port, tmp_path):
...
def test_solve_riddle_with_star_partial_success(mock_engine, mock_prompt_manager, mock_gold_dataset_port, tmp_path):
...
def test_solve_riddle_with_star_no_tag(mock_engine, mock_prompt_manager, mock_gold_dataset_port, tmp_path):
    service = StarReasonerService(
        inference_engine=mock_engine,
        prompt_manager=mock_prompt_manager,
        gold_dataset_port=mock_gold_dataset_port
...
def test_solve_riddle_with_star_engine_error(mock_engine, mock_prompt_manager, mock_gold_dataset_port, tmp_path):
    service = StarReasonerService(
        inference_engine=mock_engine,
        prompt_manager=mock_prompt_manager,
        gold_dataset_port=mock_gold_dataset_port
