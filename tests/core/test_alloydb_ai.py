...
from pipeline.vector_client import PGVectorCollectionWrapper, is_alloydb_ai_supported
...
def test_alloydb_ai_detection_success():
    with patch("django.db.connection.cursor") as mock_cursor:
        ...
        pipeline.vector_client._alloydb_ai_supported = None
...
@patch("django.db.connection.vendor", "postgresql")
@patch("pipeline.vector_client.is_alloydb_ai_supported", return_value=True)
