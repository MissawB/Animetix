...
def test_fetch_and_parse_character(
    vs_battle_service, mock_fandom_port, mock_inference_port, mock_prompt_manager
):
    # Setup
    ...
    # Verify
    mock_fandom_port.fetch_character_data.assert_any_call(
        "Naruto profile VS Battles Wiki"
    )
