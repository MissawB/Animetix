...
def vlm_service(mock_engine, mock_prompt_manager):
    return VlmIndexingService(inference_engine=mock_engine, prompt_manager=mock_prompt_manager)
...
def test_describe_poster(vlm_service, mock_engine, mock_prompt_manager):
    ...
    mock_prompt_manager.get_prompt.assert_called_with("cross_modal_analysis", title="Title")
